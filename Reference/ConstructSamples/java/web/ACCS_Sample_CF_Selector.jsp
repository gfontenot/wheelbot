...
<tr>
	<td>Make:</td>
	<td>
		<select id="division" onChange="getConsumerFriendlyModelNames();">
		</select>
	</td>
</tr>
<tr>
	<td>Consumer Friendly Model Name:</td>
	<td>
		<select id="cfmodelname" onChange="getStylesByCfModelName(this.options[this.selectedIndex].value);">
		</select>
	</td>
</tr>
</table>
