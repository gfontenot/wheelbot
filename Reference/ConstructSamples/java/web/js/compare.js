function doCompareSBS() {
	...
	for( var i = 0; i < rows.length; i++ )	{
  	...
  	document.location = "CompareSideBySideServlet?scratchListIds=" + scratchListIds;
}
...
function doCompareABC() {
    ...
    document.location = "CompareAdvantageServlet?primaryScratchListId=" + primaryScratchListId + "&scratchListIds=" + scratchListIds;
}
