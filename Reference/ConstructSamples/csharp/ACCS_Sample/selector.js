function selectLocale() {
    ...
    request.open("get", "ACCS_Sample_Selector_Data.aspx?data=locale&locale=" + locale + "&random=" + new Date(), false);  //add random so it doesn't cache
    request.send(null);
...
function selectMode() {
    ...
    //do request
    var request = getRequest();
    request.open("get", "ACCS_Sample_Selector_Data.aspx?data=orderAvailability&orderAvailability=" + mode, false);
    request.send(null);
...
function loadYears() {
	//do request
    var request = getRequest();
    request.open("get", "ACCS_Sample_Selector_Data.aspx?data=years", false);
    request.send(null);
...
function selectYear(modelYear) {
	//do request
    var request = getRequest();
    request.open("get", "ACCS_Sample_Selector_Data.aspx?data=divisions&modelYear=" + modelYear, false);
    request.send(null);
...
function selectDivision(divisionId) {
    ...
    //do request
    var request = getRequest();
    request.open("get", "ACCS_Sample_Selector_Data.aspx?data=models&modelYear=" + modelYear + "&divisionId=" + divisionId, false);
    request.send(null);
...
function getStyles() {
	...
	//do request
	var request = getRequest();
	request.open("get", "ACCS_SAMPLE_Selector_Data.aspx?data=styles&modelYear=" + modelYear + "&divisionId=" + divisionId + "&divisionName=" + divisionName + "&modelId=" + modelId + "&modelName=" + modelName, false);
  	request.send(null);
