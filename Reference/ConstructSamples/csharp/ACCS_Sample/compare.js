function doCompareSBS() {
	...
	for( var i = 0; i < rows.length; i++ )	{
  	...
  	document.location = "ACCS_SAMPLE_Compare_SBS.aspx?scratchListIds=" + scratchListIds;
}
...
function doCompareABC() {
	...
	document.location = "ACCS_SAMPLE_Compare_ABC.aspx?primaryScratchListId=" + primaryScratchListId + "&scratchListIds=" + scratchListIds;
}
