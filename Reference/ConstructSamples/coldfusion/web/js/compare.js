function doCompareSBS() {
	...
	for( var i = 0; i < rows.length; i++ )	{
  	...
  	document.location = "ACCS_Sample_Compare_SBS.cfm?scratchListIds=" + scratchListIds;
}
...
function doCompareABC() {
    ...
    document.location = "ACCS_Sample_Compare_ABC.cfm?primaryScratchListId=" + primaryScratchListId + "&scratchListIds=" + scratchListIds;
}
