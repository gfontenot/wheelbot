...
<fieldset>
    ...
    <div >
        Use this area to add criteria to your working list.  You can then use the criteria
        ...
        <table border="0" cellspacing="0" cellpadding="5" width="100%" >
            ...
            <tr>
                <td colspan="100" >
                    ...
                    <input type="button" id="genCriteriaBtn" disabled value="Add as General Criterion" onclick="processCriteriaList( ACTION_GENERAL_CRITERIA )" >&nbsp;&nbsp;
